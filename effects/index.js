...
import updateVisitedDistilleryCacheAsync from './updateVisitedDistilleryCacheAsync';
...
export default [
  ...
  {action: ActionTypes.ADD_VISITED_DISTILLERY, effect: updateVisitedDistilleryCacheAsync, error: genericErrorHandler},
  {action: ActionTypes.REMOVE_VISITED_DISTILLERY, effect: updateVisitedDistilleryCacheAsync, error: genericErrorHandler},
